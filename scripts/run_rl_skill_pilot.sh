...
run_id=rl_skill_pilot_20260909
...
export SITIAN_LAYERED_SUMMON=False SITIAN_ROLLOUT_GPU_UTIL=0.55
export SITIAN_ROLLOUT_MAX_NUM_SEQS=8 SITIAN_AGENT_WORKERS=2
export SITIAN_ROLLOUT_N=8 SITIAN_TRAIN_BATCH_SIZE=2 SITIAN_PPO_MINI_BATCH_SIZE=2
export SITIAN_TRAIN_FILE="${project_root}/data/verl/train.parquet"
